...
/**
 * Resource for creating a concrete curing sensor monitor.
 */
@Schema(
        name = "CreateConcreteCuringSensorResource",
        description = "Request payload for creating a new concrete curing sensor monitor",
        example = "{\"projectId\": \"PRJ-2026-001\", \"sensorId\": \"SNS-DHT22-09\", \"state\": 0, \"location\": \"Sector B - Column 4\", \"temperatureReading\": 25.4, \"temperatureUnit\": \"CELSIUS\", \"humidityPercentage\": 85, \"temperatureLimit\": 65.0}"
)
public record CreateConcreteCuringSensorResource(
        @NotBlank(message = "{validation.not-blank}")
        @Schema(description = "Associated project identifier", example = "PRJ-2026-001", minLength = 1, maxLength = 36)
        String projectId,
