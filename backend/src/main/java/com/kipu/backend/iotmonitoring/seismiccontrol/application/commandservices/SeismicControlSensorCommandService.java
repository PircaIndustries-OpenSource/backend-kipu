 ...
 * <p>Defines the entry point boundary for executing orchestration and state-mutation
 * operations within the seismic monitoring bounded context.</p>
 */
public interface SeismicControlSensorCommandService {
     ...
     * @return A {@link Result} containing the fully initialized and persisted {@link SeismicControlSensor} on success,
     * or an {@link ApplicationError} detailing business rule violations or mapping failures.
     */
