...
@Schema(description = "Request resource for an item inside a material request update")
public record UpdateMaterialRequestItemResource(
        ...
        @Schema(description = "Requested quantity", example = "50.00", requiredMode = Schema.RequiredMode.REQUIRED)
