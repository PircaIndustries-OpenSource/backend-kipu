...
/**
 * Command for updating an existing material waste record.
 *
 ...
 * @param reportedBy         identifier (DNI or name) of the person reporting
 * @param photoUrl           optional photo URL (may be null or empty)
 */
public record UpdateMaterialWasteCommand(
        Long id,
        ProjectId projectId,
    ...
    public UpdateMaterialWasteCommand {
