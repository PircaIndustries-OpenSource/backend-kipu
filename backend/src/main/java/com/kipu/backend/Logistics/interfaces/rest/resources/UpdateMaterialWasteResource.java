...
@Schema(description = "Request resource used to update a material waste record")
public record UpdateMaterialWasteResource(
        ...
        @Schema(description = "Description of the waste event", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "material.waste.error.description.notBlank")
        @Size(max = 500, message = "material.waste.error.description.tooLong")
        String description,

        @Schema(description = "DNI or name of the person reporting the waste", requiredMode = Schema.RequiredMode.REQUIRED)
