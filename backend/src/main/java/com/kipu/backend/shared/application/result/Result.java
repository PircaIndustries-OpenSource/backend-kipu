...
public sealed interface Result<T, E> {
    ...
    /**
     * Folds this result into a single value by applying the corresponding mapper function.
     * This replaces the old procedural approach with modern pattern matching.
     */
